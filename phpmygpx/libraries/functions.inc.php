<?php
/**
* @version $Id: functions.inc.php 341 2010-08-22 20:59:49Z sebastian $
* @package phpmygpx
...
function db_connect_h($host, $db, $user, $pw) {
    $link = mysql_connect($host, $user, $pw)
        or die($outstr[0][0]."Keine Verbindung zur Datenbank möglich!".$outstr[0][1]);
    mysql_select_db($db)
        or die($outstr[0][0]."Die Datenbank existiert nicht!".$outstr[0][1]);
    return $link;
}
